...
opkg install alist_2.1.0-1_aarch64_generic.ipk && rm alist_2.1.0-1_aarch64_generic.ipk
opkg install luci-app-alist_1.0.2_all.ipk && rm luci-app-alist_1.0.2_all.ipk
opkg install luci-i18n-alist-zh-cn_git-22.062.75936-0030bc0_all.ipk && rm luci-i18n-alist-zh-cn_git-22.062.75936-0030bc0_all.ipk

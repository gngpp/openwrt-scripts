...
opkg install ttyd luci-i18n-ttyd-zh-cn luci-app-nlbwmon luci-i18n-nlbwmon-zh-cn luci-app-aria2 luci-i18n-aria2-zh-cn luci-app-openvpn luci-i18n-openvpn-zh-cn
